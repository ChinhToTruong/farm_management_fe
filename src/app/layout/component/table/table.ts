import { AfterViewInit, ChangeDetectorRef, Component, ElementRef, EventEmitter, Input, OnInit, Output, signal, TemplateRef, ViewChild } from '@angular/core';
...
import { CommonConfirmService } from '../confirmtoast/confirm-toast';
import { PreviewComponent } from '@/pages/service/preview/common-preview.service';
...
export class AppTable implements OnInit {
    ...
    @ViewChild('previewCmp') preview!: PreviewComponent;

    constructor(private confirm: CommonConfirmService) {}

    exportCSV() {
        console.log('vodc r');
        
        this.preview.openPreview('Báo cáo tiêm chủng');
